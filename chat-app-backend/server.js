...
const mongoURI = `mongodb+srv://${process.env.MONGO_USERNAME}:${process.env.MONGO_PASSWORD}@cluster0.kec5n.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
